<?php if ( ! mylisting()->shortcodes()->all() ) return; ?>

<div class="tabs" id="case27-shortcode-generator" data-shortcodes="<?php echo esc_attr( mylisting()->shortcodes()->all_encoded() ) ?>">
	<div class="wrapper">
		...
		<div class="column shortcode-options">
			...
			<?php foreach (mylisting()->shortcodes()->all() as $key => $shortcode): ?>
