...
class CASE27_WooCommerce_Queries {

	public function __construct() {
		// Get products.
		add_action( "wp_ajax_c27_get_products", [ $this, 'c27_get_products' ] );
		add_action( "wp_ajax_nopriv_c27_get_products", [ $this, 'c27_get_products' ] );
	}
