...
class CASE27_Elementor_Widget_Accordion_Block extends Widget_Base {
...
Plugin::instance()->widgets_manager->register_widget_type( new CASE27_Elementor_Widget_Accordion_Block() );
